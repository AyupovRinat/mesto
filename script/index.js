const popupInfo = document.querySelector('.popup__type_info');
const popupCard = document.querySelector('.popup__type_card-add');
const popupImage = document.querySelector('.popup_fullscreen_image');
